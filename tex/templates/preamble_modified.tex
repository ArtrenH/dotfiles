...
\newtcbtheorem[number within=chapter, use counter=thm]{Theorem}{Theorem}
{%
	enhanced,
	breakable,
	colback = mytheorembg,
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=chapter, use counter=prop]{Prop}{Proposition}
{%
	enhanced,
	breakable,
	colback = mypropbg,
...
\newcommand{\lecturedivider}[1]{
  ...
  \vspace{-1.2em}
  \begin{center}
    \textbf{Vorlesung vom #1} % Date centered
  \end{center}
  \vspace{-1.5em}
  \noindent
