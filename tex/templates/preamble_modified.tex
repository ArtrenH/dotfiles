...
\newtcbtheorem[number within=section, use counter=thm]{Theorem}{Theorem}
{%
	enhanced,
	breakable,
	colback = mytheorembg,
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=chapter, use counter=cor]{Corollary}{Korollar}
{%
	enhanced
	,breakable
	,colback = myp!10
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=chapter, use counter=lemma]{mlemma}{Lemma}
{%
	enhanced,
	breakable,
	colback = mylemmabg,
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=chapter, use counter=fact]{fact}{Fakt}
{%
	enhanced,
	breakable,
	colback = white,
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=chapter, use counter=notation]{notation}{Notation}
{%
	enhanced,
	breakable,
	colback = white,
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[no counter]{Behauptung}{Behauptung}
{%
	enhanced,
	breakable,
	colback = mylemmabg,
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=section, use counter=prop]{Prop}{Proposition}
{%
	enhanced,
	breakable,
	colback = mypropbg,
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=chapter, use counter=clm]{claim}{Satz}
{%
	enhanced
	,breakable
	,colback = myg!10
...
\newtcbtheorem[number within=chapter, use counter=ex]{Example}{Beispiel}
{%
	colback = myexamplebg
	,breakable
...
\newtcbtheorem[number within=chapter, use counter=dfn]{Definition}{Definition}{enhanced,
...
\tcbuselibrary{skins}
\newtcbtheorem[number within=chapter, use counter=nt]{note}{Bemerkung}{
	enhanced jigsaw,
...
\newcommand{\nt}[2]{\begin{note}{#1}{}\setlength{\parindent}{1cm}#2\end{note}}
