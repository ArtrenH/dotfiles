...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=chapter, use counter=claim]{claim}{Satz}
{%
	enhanced
	,breakable
	,colback = myg!10
...
\newtcbtheorem[number within=chapter, use counter=example]{Example}{Beispiel}
{%
	colback = myexamplebg
	,breakable
...
\newtcbtheorem[number within=chapter, use counter=definition]{Definition}{Definition}{enhanced,
