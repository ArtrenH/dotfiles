...
\newcommand{\oneCounterBoxes}{
    \usetikzlibrary{arrows,calc,shadows.blur}
    \newcounter{boxCounter} \numberwithin{boxCounter}{section}
    \makeatletter
    \renewcommand{\theboxCounter}{\arabic{section}.\arabic{boxCounter}} % Only section + counter
    \makeatother


    \newtcbtheorem[number within=section, use counter=boxCounter]{Definition}{Definition}{Definition style}{def}
    \newtcbtheorem[number within=section, use counter=boxCounter]{claim}{Satz}{claim style}{th}
    ...
    \newtcbtheorem[number within=section, use counter=boxCounter]{Prop}{Proposition}{Prop style}{th}
    \newtcbtheorem[number within=section, use counter=boxCounter]{Obs}{Beobachtung}{Obs style}{th}
...
\newcommand{\EinfAlgBoxes}{
    ...
    \newtcbtheorem[number within=section, use counter=boxCounter]{mlemma}{Lemma}{Lemma style}{th}
    \newtcbtheorem[number within=section, use counter=boxCounter]{Corollary}{Corollary}{Corollary style}{th}
    \newtcbtheorem[number within=section, use counter=boxCounter]{Prop}{Proposition}{Prop style}{th}
    \newtcbtheorem[number within=section, use counter=boxCounter]{fact}{Fact}{Fact style}{th}

    \newtcbtheorem[number within=section, use counter=boxCounter]{note}{Note}{Note style}{def}
    \newtcbtheorem[number within=section, use counter=boxCounter]{Example}{Example}{Example style}{ex}
    \newtcbtheorem[number within=section, use counter=boxCounter]{notation}{Notation}{Fact style}{th}
    \newtcbtheorem[number within=section, use counter=boxCounter]{convention}{Convention}{Fact style}{th}
    \newtcbtheorem[no counter]{Behauptung}{Behauptung}{Behauptung style}{th}
...
\newcommand{\edmBoxes}{
    ...
    \newtcbtheorem[no counter]{Definition}{Definition}{Definition style, theorem name}{def}
...
\makeatletter
\newtcbtheorem[no counter]{problem}{Problem}{enhanced,
	breakable,
	colback=white,
	colframe=myb!80!black,
	attach boxed title to top left={yshift*=-\tcboxedtitleheight},
...
\newcommand{\lemmastar}[2]{\begin{mlemma*}{#1}{}#2\end{mlemma*}}
\newcommand{\nota}[2]{\begin{notation}{#1}{}#2\end{notation}}
\newcommand{\notastar}[2]{\begin{notation*}{#1}{}#2\end{notation*}}
\newcommand{\fac}[2]{\begin{fact}{#1}{}#2\end{fact}}
\newcommand{\facstar}[2]{\begin{fact*}{#1}{}#2\end{fact*}}
\newcommand{\conv}[2]{\begin{convention}{#1}{}#2\end{convention}}
\newcommand{\convstar}[2]{\begin{convention*}{#1}{}#2\end{convention*}}
...
\newcommand{\obs}[2]{\begin{Obs}{#1}{}#2\end{Obs}}

\newcommand{\thm}[2]{\begin{Theorem}{#1}{}#2\end{Theorem}}
\newcommand{\thmstar}[2]{\begin{Theorem*}{#1}{}#2\end{Theorem*}}
...
\newcommand{\lecturedivider}[2]{
  ...
  \vspace{-1.2em}
  \begin{center}
    \textbf{#1. Lecture - #2} % Date centered
  \end{center}
  \vspace{-1.5em}
  \noindent
